...
while True:
    ...
    if cv.waitKey(1) & 0xFF == ord('q') or dem >= 100: #dừng khi đã lấy đủ 100 mẫu hoặc nhấn 'q'
        break
cap.release()
